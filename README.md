...
# 🥊 UFC Fight Predictor
A machine learning project that predicts the winner of UFC fights using a **Logistic Regression model** with **69.33%** accuracy. The model is served via a **RESTful API** built with **FastAPI**, containerized with **Docker**, and deployed on **AWS ECS** for scalable performance.
